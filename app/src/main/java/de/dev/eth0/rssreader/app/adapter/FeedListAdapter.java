 ...
 * @author deveth0
 */
public class FeedListAdapter extends AbstractRecyclerViewAdapter<FeedListHolder, FeedEntryMetadata> {
   ...
   * @param listener
   */
  public FeedListAdapter(List<FeedEntryMetadata> content, AbstractBaseActivity activity, View.OnClickListener listener) {
  ...
  public FeedListHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    View itemView = LayoutInflater.
            ...
            inflate(R.layout.feed_summary_list_entry, viewGroup, false);
    itemView.setOnClickListener(getListener());
    return new FeedListHolder(itemView, getActivity());
  }
